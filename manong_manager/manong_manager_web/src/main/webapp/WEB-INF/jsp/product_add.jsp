...
<div style="padding: 10px 10px 10px 10px">
    <form id="productAddForm" method="post">
       ...
       <table cellpadding="10px">
           ...
           <tr>
               <td>商品价格</td>
               <td><input class="easyui-numberbox" data-options="min:1,max:999999999,precision:2,required:true" style="width:1200px" name="pricePreview">
           ...
           <tr>
               <td>商品编号</td>
               <td>
                    <input class="easyui-numberbox" data-options="required:true" style="width:1200px" name ="productNumber">
               </td>
           </tr>
           ...
           <tr>
               <td>主图预览</td>
               <td>
                   <img src="" id ="img" width="400" height="200">
               </td>
           </tr>
...
<div align="center">
    ...
    <a id="btn3" href="#" class="easyui-linkbutton">重置</a>
</div>
